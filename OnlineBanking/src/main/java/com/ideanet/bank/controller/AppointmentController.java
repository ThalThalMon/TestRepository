...
public class AppointmentController {
	...
	public String createAppointmentPost(@ModelAttribute("appointment") Appointment appointment,@ModelAttribute("dateString") String dateString,Model model,Principal principal) throws ParseException{
